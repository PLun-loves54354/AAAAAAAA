...
-- HELPERS TAB
-- =====================================
local HelpLinesSection = HelpersTab:CreateSection("Directional Lines")
...
InfoTab:CreateButton({
    ...
    Callback = function()
        Luna:Notification({
            Title = "📊 System Status",
            Content = "Enabled: " .. (Hitbox.Enabled and "✅" or "❌") ..
                    "\nInterval: " .. Hitbox.Interval .. "s" ..
                    "\nSize: " .. Hitbox.MinSize .. "x - " .. Hitbox.MaxSize .. "x" ..
                    "\nTransparency: " .. string.format("%.2f", Hitbox.Transparency),
        })
    end
})
